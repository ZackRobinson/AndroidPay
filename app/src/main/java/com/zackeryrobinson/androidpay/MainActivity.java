package com.zackeryrobinson.androidpay;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    //defines the information about the order and what you're requesting from the customer
    private MaskedWalletRequest generateMaskedWalletRequest(){
        ...
        MaskedWalletRequest maskedWalletRequest =
                MaskedWalletRequest.newBuilder() // Builder pattern is easier to implement than a telescoping constructor
